...
public class GameVisualizer extends JPanel implements Observer
{
    ...
    public void paint(Graphics g)
    {
        ...
        drawRobot(g2d, robotModel.getM_robotPositionX(), robotModel.getM_robotPositionY(), robotModel.getM_robotDirection());
    ...
    {
        int robotCenterX = RobotMath.round(x);
        int robotCenterY = RobotMath.round(y);
